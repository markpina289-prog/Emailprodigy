                ...
                <table width="600" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" style="border-radius:8px; box-shadow:0 2px 8px rgba(0,0,0,0.1); overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:32px 32px 24px 32px; color:#202124; line-height:1.5;">
                            ...
                            <!-- CTA Button -->
                            <a href="https://myaccount.google.com/security" target="_blank" style="display:inline-block; background:#1a73e8; color:#ffffff; text-decoration:none; font-weight:500; font-size:15px; padding:12px 24px; border-radius:4px; margin-bottom:24px;">
                                Review your account activity
                            </a>
                            
                            <p style="margin:0; font-size:14px; color:#5f6368;">This secure link will expire in 24 hours.</p>
                        </td>
                    </tr>
